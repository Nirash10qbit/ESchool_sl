...
public class analysegrade extends AppCompatActivity {
...
//    ArrayList<chartMarks> chartMarksArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysegrade);
...
//        tva3 =findViewById(R.id.tva3);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analysegrade.this,analysesub.class);
...
//        });
//
//        VolleySingleton.getInstance(analysegrade.this).addToRequestQueue(jsonObjectRequest);
...
//        });
//
//        VolleySingleton.getInstance(analysegrade.this).addToRequestQueue(jsonObjectRequest2)   ;
...
//        });
//
//        VolleySingleton.getInstance(analysegrade.this).addToRequestQueue(jsonObjectRequest5)   ;
...
//            }
//        });
//        VolleySingleton.getInstance(analysegrade.this).addToRequestQueue(jsonObjectRequest6);
    ...
    public void loadSession(){
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        error.printStackTrace();
                        Toast.makeText(analysegrade.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
