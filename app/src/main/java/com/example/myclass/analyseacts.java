...
public class analyseacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyseacts);
            ...
            public void run() {
                ...
                barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                    ...
                    public void onValueSelected(Entry e, Highlight h) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(analyseacts.this);
                        builder.setCancelable(true);
                        View nview = LayoutInflater.from(analyseacts.this).inflate(R.layout.chart_stns,null);
        ...
        lv2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analyseacts.this,analyselesss.class);
    ...
    public void backanalyseact(View view) {
        Intent intent = new Intent(this, analysesubs.class);
        intent.putExtra("uname", stn);
        intent.putExtra("gid",sta);
        intent.putExtra("aname",staname);
        intent.putExtra("stnc",stnc);
    ...
    public void loadSession() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, "https://eschoolslgit1.000webhostapp.com/acte.php?gid="+sta+"&&sid="+stb+"&&bid="+bid+"", null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(analyseacts.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
       ...
       JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/zgetlabsubs.php?gid="+sta+"&&sid="+ stb +"&&bid="+ bid +"", null,
        ...
        VolleySingleton.getInstance(analyseacts.this).addToRequestQueue(jsonObjectRequest2)   ;
