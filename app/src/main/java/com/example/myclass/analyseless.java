...
public class analyseless extends AppCompatActivity {
    ...
    String stz,st2,stn, sta,staname, stb,stbname,total,sl1,sl2,sl3,sl4,sl5,stnc,stzname,stlen;
    TextView tvsu,tvto,tvl1,tvl2,tvl3,tvl4,tvl5,tvl6,tv20,tvasu,tvbsu,tvlen,tvl62,tvse1,tvse2,tvse3,tvse4,tvse5,tvse6,tvse7,tvsu2,tvse8;
    ...
    public void loadSession() {
        ...
        JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.POST, "https://eschoolslgit1.000webhostapp.com/lengthsub.php?aid="+sta+"&&bid="+stb+"&&zid="+stz+"", null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
        ...
        VolleySingleton.getInstance(analyseless.this).addToRequestQueue(jsonObjectRequest2)   ;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            tvl62.setText(response.getString("zstn"));
