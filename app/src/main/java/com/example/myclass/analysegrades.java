...
public class analysegrades extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysegrades);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analysegrades.this,analysesubs.class);
    ...
    public void loadSession(){
        ...
        String url = "https://eschoolslgit1.000webhostapp.com/grades.php?stnc=2";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(analysegrades.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
