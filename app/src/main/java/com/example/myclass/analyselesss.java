...
public class analyselesss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyselesss);
            ...
            public void run() {
                ...
                barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                    ...
                    public void onValueSelected(Entry e, Highlight h) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(analyselesss.this);
                        builder.setCancelable(true);
                        View nview = LayoutInflater.from(analyselesss  .this).inflate(R.layout.chart_stns,null);
    ...
    public void backanalyseact(View view) {
        Intent intent = new Intent(this, analyseacts.class);
    ...
    public void loadSession() {
        ...
        VolleySingleton.getInstance(analyselesss.this).addToRequestQueue(jsonObjectRequest)   ;
        ...
        VolleySingleton.getInstance(analyselesss.this).addToRequestQueue(jsonObjectRequest2)   ;
    }
}
