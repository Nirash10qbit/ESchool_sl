...
public class analyselesst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyselesst);
            ...
            public void run() {
                ...
                barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                    ...
                    public void onValueSelected(Entry e, Highlight h) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(analyselesst.this);
                        builder.setCancelable(true);
                        View nview = LayoutInflater.from(analyselesst.this).inflate(R.layout.chart_stnt,null);
    ...
    public void backanalyseact(View view) {
        Intent intent = new Intent(this, analyseactt.class);
    ...
    public void loadSession() {
        ...
        VolleySingleton.getInstance(analyselesst.this).addToRequestQueue(jsonObjectRequest)   ;
        ...
        VolleySingleton.getInstance(analyselesst.this).addToRequestQueue(jsonObjectRequest2)   ;
    }
}
