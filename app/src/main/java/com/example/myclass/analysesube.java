...
public class analysesube extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysesube);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analysesube.this,analyseacte.class);
    ...
    public void loadSession() {
        ...
        String url = "https://eschoolslgit1.000webhostapp.com/sube.php?gid=" + sta + "&&lan=en";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(analysesube.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(analysesube.this).addToRequestQueue(jsonObjectRequest6);
    ...
    public void loadSession1() {
        ...
        VolleySingleton.getInstance(analysesube.this).addToRequestQueue(jsonObjectRequest7);
    }
