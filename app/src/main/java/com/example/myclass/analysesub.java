...
public class analysesub extends AppCompatActivity {
    ...
    String st1,st2,st3,st4,stn, sta,staname,sl1,sl2,sl3,sl4,sl5,stnc,stann;
    TextView tv1,tv2,tv3,tv4,tvgr,tvl1,tvl2,tvl3,tvl4,tvl5,tvl6,tv3a,tvf,tvl7,sel;
    ListView lv;
    ...
    public void setSessions(JSONArray response) {
        ...
        try {
            ...
            //1.layout file
            int layout = R.layout.zanalyseasub;
            //2.views
