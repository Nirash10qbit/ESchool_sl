...
public class analysesubt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysesubt);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analysesubt.this,analyseactt.class);
    ...
    public void loadSession() {
        ...
        String url = "https://eschoolslgit1.000webhostapp.com/sube.php?gid=" + sta + "&&lan=t";
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(analysesubt.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(analysesubt.this).addToRequestQueue(jsonObjectRequest6);
    ...
    public void loadSession1() {
        ...
        VolleySingleton.getInstance(analysesubt.this).addToRequestQueue(jsonObjectRequest7);
    }
