...
public class analyseactt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyseactt);
        ...
        handler.postDelayed (new Runnable ( ) {
            ...
            public void run() {
                ...
                description.setText("மதிப்பெண்கள்");
                ...
                barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                    ...
                    public void onValueSelected(Entry e, Highlight h) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(analyseactt.this);
                        builder.setCancelable(true);
                        View nview = LayoutInflater.from(analyseactt.this).inflate(R.layout.chart_stnt,null);
        ...
        lv2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                ...
                Intent intent = new Intent(analyseactt.this,analyselesst.class);
    ...
    public void backanalyseact(View view) {
        Intent intent = new Intent(this, analysesubt.class);
        intent.putExtra("uname", stn);
        intent.putExtra("gid",sta);
        intent.putExtra("aname",staname);
        intent.putExtra("stnc",stnc);
    ...
    public void loadSession() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, "https://eschoolslgit1.000webhostapp.com/acte.php?gid="+sta+"&&sid="+stb+"&&bid="+bid+"", null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(analyseactt.this, "Please check your internet connection.", Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(analyseactt.this).addToRequestQueue(jsonObjectRequest2)   ;
